...
{% note %}
This article applies to privacy practices on individual Ares games. For our website privacy policy, see [Privacy](/privacy.html).
{% endnote %}
...
{% warning %}
Just as with any online service, **any** data transmitted to the server and/or stored in the database is ultimately accessible to the game owner and anyone they choose to share it with.
{% endwarning %}
